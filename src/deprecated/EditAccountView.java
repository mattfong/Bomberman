...
public class EditAccountView {
     ...
     * <p>
     * It has three buttons. One to go to a menu that will allow the user to
     * change their name, one that allows the user to change their password, and
     * one button to go back to the playGameMenu
     * <p>
     * 
     * <p>
     * The purpose of this method is allow the user to chose what about their
     * account they want to modify. Or they may chose not to.
     * <p>
     */

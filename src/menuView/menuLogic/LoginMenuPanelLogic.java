...
public class LoginMenuPanelLogic {
	 ...
	 * 
	 * This sends the username and password through a string of if/else statements. 
	 * They check that all the requirements are met. If a requirement is not met it will return false and display 
	 * a controlling frame with a message about what is wrong. 
	 * 
	 * And even more explanations to follow in consecutive
	 * paragraphs separated by HTML paragraph breaks.
	 *
	 * @param  This is sent the username and password for an account the user wants to create          
	...
	public boolean valid(String userName, String password) throws HeadlessException, IOException{
		...
		//password must have one of each the following:upper case, lower case, number special

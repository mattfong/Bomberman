...
public class LevelSelectPanelLogic {
	...
	/**
	 * This is sent the numbers of levels unlocked and the currentl level. If this level is 
	 * "unlocked", or is less that/equal to the levels unlocked it returns true.
	...
	public boolean visable(int levelsUnlocked, int thisLevel){
	 ...
	 /**
	  * When sent a int that is the level number this will start the game at that level
	  * @param level
	  */
	public void play(int level ){
	 ...
	 /**
	  * This displays a conrolling frame to tell the user that the level is locked
	  */
	 public void locked(){

...
/**
 * Testing the CSVwriter class, and some of the methods in accountManager 
 * were also tested during this process. All the setters and getters methods 
 * in the Account were tested. 
...
public class CSVwriterTest {
	...
	/**
	 * Testing if 10 accounts can be created, and if the information entered in a CSV file, also
	 * matches the information in account manager 
	 * 
	 * @throws IOException
	 */
	@Test
	...
	/**
	 * Testing if a list of 10 accounts can be added to accountManager, and 
	 * be entered in a CSV file.
	 * @throws IOException
	 */
	@Test

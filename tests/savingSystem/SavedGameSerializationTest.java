...
public class SavedGameSerializationTest {
	...
	/**
	 * Only testing if the first deserialized object in the list is the same as the
	 * object saved on the file. Also, testing removal of a game saved in the serialized file. 
	 * Tested all the methods in this test.
	 */
	@Test
	public void test() {
